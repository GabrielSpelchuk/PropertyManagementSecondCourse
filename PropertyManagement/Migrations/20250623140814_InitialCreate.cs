    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "ivan@example.com", "Ivan Petrenko", "hashed", "Seller" });

            migrationBuilder.InsertData(
                table: "Properties",
                columns: new[] { "Id", "Address", "CreatedAt", "Description", "OwnerId", "Price", "PropertyTypeId", "Title" },
                values: new object[] { 1, "Lviv, Franka St.", new DateTime(2024, 6, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "2-bedroom, cozy, balcony", 1, 55000m, 1, "Modern Apartment" });
